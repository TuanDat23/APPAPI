...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String API_LAST_ID = "http://10.0.2.2:5000/last_id"; // Sử dụng 10.0.2.2 cho emulator
    private static final String API_GET_ID = "http://10.0.2.2:5000/get_id?id=";
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, API_LAST_ID, null,
                response -> {
                    try {
                        ...
                        Log.e("API", "Lỗi JSON: " + e.getMessage());
                    }
                },
                error -> Log.e("API", "Lỗi API: " + error.toString())
        );
                ...
                response -> {
                    try {
                        if (response.getInt("ok") == 1) {
                            String message = response.getJSONObject("msg").getString("msg");
